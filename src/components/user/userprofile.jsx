                ...
                <div className="content-body">
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="card profile-with-cover">
                                    <div className="card-img-top img-fluid bg-cover height-300" style={{ background: 'url("../../../app-assets/images/carousel/22.jpg") 50%' }} />
                                    <div className="media profil-cover-details w-100">
                                        <div className="media-left pl-2 pt-2">
                                            <a href="#" className="profile-image">
                                                <img src="../../../app-assets/images/portrait/small/avatar-s-8.png" className="rounded-circle img-border height-100" alt="Card image" />
                                            </a>
                                        </div>
                                        <div className="media-body pt-3 px-2">
                                            <div className="row">
                                                <div className="col">
                                                    <h3 className="card-title">Jose Diaz</h3>
                                                </div>
                                                <div className="col text-right">
                                                    <button type="button" className="btn btn-primary d-"><i className="la la-plus" /> Follow</button>
                                                    <div className="btn-group d-none d-md-block float-right ml-2" role="group" aria-label="Basic example">
                                                        <button type="button" className="btn btn-success"><i className="la la-dashcube" /> Message</button>
                                                        <button type="button" className="btn btn-success"><i className="la la-cog" /></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <nav className="navbar navbar-light navbar-profile align-self-end">
                                        <button className="navbar-toggler d-sm-none" type="button" data-toggle="collapse" aria-expanded="false" aria-label="Toggle navigation" />
                                        <nav className="navbar navbar-expand-lg">
                                            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                                <ul className="navbar-nav mr-auto">
                                                    <li className="nav-item active">
                                                        <a className="nav-link" href="#"><i className="la la-line-chart" /> Timeline <span className="sr-only">(current)</span></a>
                                                    </li>
                                                    <li className="nav-item">
                                                        <a className="nav-link" href="#"><i className="la la-user" /> Profile</a>
                                                    </li>
                                                    <li className="nav-item">
                                                        <a className="nav-link" href="#"><i className="la la-briefcase" /> Projects</a>
                                                    </li>
                                                    <li className="nav-item">
                                                        <a className="nav-link" href="#"><i className="la la-heart-o" /> Favourites</a>
                                                    </li>
                                                    <li className="nav-item">
                                                        <a className="nav-link" href="#"><i className="la la-bell-o" /> Notifications</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </nav></nav></div>
                    ...
                    <section id="timeline" className="timeline-center timeline-wrapper">
                                                ...
                                                <div className="media">
                                                    ...
                                                    <div className="media-body">
                                                        ...
                                                        <ul className="list-inline">
                                                            ...
                                                            <li className="pr-1">
                                                                <a href="#" className>
                                                                    <span className="la la-commenting-o" /> Reply</a>
                                                            </li>
                                                        </ul>
                                                        <div className="media">
                                                            <div className="media-left mr-1">
                        ...
                        <ul className="timeline">
                            ...
                            <li className="timeline-item">
                                <div className="timeline-badge">
                                    <span className="bg-purple bg-lighten-1" data-toggle="tooltip" data-placement="right" title="Nullam facilisis fermentum"><i className="la la-area-chart" /></span>
                                </div>
                                <div className="timeline-card card border-grey border-lighten-2">
                                    <div className="card-header">
                                        ...
                                        <div className="card-content">
                                            <div className="card-body">
                                                <p className="card-text">Nullam facilisis fermentum aliquam. Suspendisse ornare dolor
                                                    ...
                                                    elit tellus, porta ut orci sed, fermentum bibendum nisi.</p>
                                                <div className="chart-container">
                                                    <div id="non-ribbon-chord" className="height-400 overflow-hidden echart-container" />
                                                </div>
                                            </div>
                                        </div>
                                        <div className="card-footer px-0 py-0">
