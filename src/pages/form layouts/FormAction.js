            ...
            <section id="form-action-layouts">
                    ...
                    <div className="card-content collpase show">
                      <div className="card-body">
                        <div className="card-text">
                          ...
                          <p>
                            To add form actions on top of the form add a div
                            with <code>.form-actions</code> class to begin the
                            form. Add <code>.top</code> class to add border
                            below form actions.
                          </p>
                        </div>
                        <form className="form">
                          ...
                          <div className="form-body">
                            ...
                            <h4 className="form-section">
                              <i className="ft-clipboard" /> Requirements
                            </h4>
                            <div className="row">
                    ...
                    <div className="card-content collpase show">
                      <div className="card-body">
                        <div className="card-text">
                          ...
                          <p>
                            To add form actions on bottom of the form add a div
                            with <code>.form-actions</code> class to end the
                            form. This is the default position for form actions.
                            We have added <code>.right</code> class to move
                        ...
                        <form className="form">
                          <div className="form-body">
                            <h4 className="form-section">
                              <i className="la la-eye" /> About User
                            </h4>
                            <div className="row">
                              <div className="form-group col-md-6 mb-2">
                            ...
                            <h4 className="form-section">
                              <i className="ft-mail" /> Contact Info &amp; Bio
                            </h4>
                            <div className="row">
                              <div className="form-group col-12 mb-2">
                  ...
                  <div className="card">
                    <div className="card-header">
                      <h4
                        ...
                        id="from-actions-top-bottom-left"
                      >
                        Issue Tracking
                      </h4>
                      <Link className="heading-elements-toggle">
                    ...
                    <div className="card-content collpase show">
                      <div className="card-body">
                        <div className="card-text">
                          ...
                          <p>
                            To add form actions on top and bottom of the form
                            add a div with <code>.form-actions</code> class to
                ...
                <div className="col-md-6">
                  <div className="card">
                    <div className="card-header">
                      <h4
                        className="card-title"
                        id="from-actions-top-bottom-right"
                      >
                        Timesheet
                      </h4>
                      <Link className="heading-elements-toggle">
                      ...
                      <div className="card-body">
                        <div className="card-text">
                          ...
                          <p>
                            To add form actions on top and bottom of the form
                            add a div with <code>.form-actions</code> class to
                            start and end the form. Add <code>.right</code>{" "}
                ...
                <div className="col-md-6">
                  <div className="card">
                    <div className="card-header">
                      <h4
                        className="card-title"
                        id="from-actions-center-dropdown"
                      >
                        Complaint Form
                      </h4>
                      <Link className="heading-elements-toggle">
                      ...
                      <div className="card-body">
                        <div className="card-text">
                          ...
                          <p>
                            To add form actions on bottom of the form add a div
                            with <code>.form-actions</code> class to end the
                            form. Add <code>.center</code> class to align the
                            form action buttons to center. We can also add more
                            form action using dropdown button to the top right
                            corner of the form.
                          </p>
                        </div>
                        <form className="form">
                      ...
                      <div className="card-body">
                        <div className="card-text">
                          ...
                          <p>
                            ...
                            with <code>.form-actions</code> class to end the
                            form. Add <code>.center</code> class to align the
                            form action buttons to center. We can also search
                            bar action of the form.
                          </p>
                        </div>
                        <form className="form">
                          <div className="form-body">
              ...
              <div className="row">
                <div className="col-md-12">
                  <div className="card">
                    <div className="card-header">
                      <h4 className="card-title" id="from-actions-multiple">
                        Event Registration
                      </h4>
                      <Link className="heading-elements-toggle">
                        <i className="la la-ellipsis-v font-medium-3" />
                      ...
                      <div className="card-body">
                        <div className="card-text">
                          ...
                          <p>
                            To add form actions on top and bottom of the form
                            add a div with <code>.form-actions</code> class to
                            start and end the form. Add{" "}
                            <code>.buttons-group</code> class along with{" "}
                            <code>.float-*</code> class to pull the buttons
                            group to either left or right.
                          </p>
                        </div>
                        <form className="form">
                      ...
                      <div className="card-body">
                        <div className="card-text">
                          ...
                          <p>
                            To add form actions on top and bottom of the form
                            add a div with <code>.form-actions</code> class to
                            start and end the form. Add <code>.center</code>{" "}
