                            ...
                            <div className="row breadcrumbs-top d-inline-block">
                                <div className="breadcrumb-wrapper col-12">
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item active"><Link to="#">Horizontal Forms</Link>
                                        </li>
                                    </ol>
                                </div>
                            </div>
                        ...
                        <section id="horizontal-form-layouts">
                                ...
                                <div className="col-md-12">
                                    <div className="card">
                                        <div className="card-header">
                                            <h4 className="card-title" id="horz-layout-basic">Project Info</h4>
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="card">
                                        <div className="card-header">
                                            <h4 className="card-title" id="horz-layout-icons">Timesheet</h4>
                                            <Link className="heading-elements-toggle"><i className="la la-ellipsis-v font-medium-3" /></Link>
                                            <div className="heading-elements">
                                                <ul className="list-inline mb-0">
                                                    <li><Link data-action="collapse"><i className="ft-minus" /></Link></li>
                            ...
                            <div className="row justify-content-md-center">
                                <div className="col-md-6">
                                    <div className="card">
                                        <div className="card-header">
                                            <h4 className="card-title" id="horz-layout-card-center">Event Registration</h4>
                                            <Link className="heading-elements-toggle"><i className="la la-ellipsis-v font-medium-3" /></Link>
                                            <div className="heading-elements">
                                                <ul className="list-inline mb-0">
                                                    <li><Link data-action="collapse"><i className="ft-minus" /></Link></li>
